"""Исполнитель SFTP-операций для передачи файлов между локальным и удалённым хостами.

Поддерживает загрузку (upload) и скачивание (download) файлов через SFTP,
отслеживание прогресса передачи, таймауты и прерывание операций, а также
автоматическое определение направления передачи по формату команды source::destination."""
