"""Редактор команд: создание, редактирование, импорт/экспорт и управление.tasks и категориями."""
...
class CommandEditorDialog(QDialog):
    def __init__(self, parent: QWidget | None = None):
        ...
        self.timeoutSpinBox.lineEdit().textEdited.connect(lambda _: self.set_modified())
    ...
    def _save_current_item(self, current: QModelIndex = None):
        ...
        self.timeoutSpinBox.interpretText()
